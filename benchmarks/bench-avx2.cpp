...
BENCHMARK(avx2_qselect<double>)->Arg(10)->Arg(100)->Arg(1000)->Arg(5000);
BENCHMARK(avx2_qselect<uint64_t>)->Arg(10)->Arg(100)->Arg(1000)->Arg(5000);
BENCHMARK(avx2_qselect<int64_t>)->Arg(10)->Arg(100)->Arg(1000)->Arg(5000);