...
X86_SIMD_SORT_INLINE zmm_t sort_zmm_64bit(zmm_t key_zmm, index_type &index_zmm)
{
    ...
    key_zmm = cmp_merge<vtype1, vtype2>(
            key_zmm,
            vtype1::permutexvar(_mm512_set_epi64(NETWORK_64BIT_1), key_zmm),
            index_zmm,
            vtype2::permutexvar(_mm512_set_epi64(NETWORK_64BIT_1), index_zmm),
            0xCC);
    key_zmm = cmp_merge<vtype1, vtype2>(
            key_zmm,
            vtype1::template shuffle<SHUFFLE_MASK(1, 1, 1, 1)>(key_zmm),
    ...
    key_zmm = cmp_merge<vtype1, vtype2>(
            key_zmm,
            vtype1::permutexvar(rev_index, key_zmm),
            index_zmm,
            vtype2::permutexvar(rev_index, index_zmm),
            0xF0);
    key_zmm = cmp_merge<vtype1, vtype2>(
            key_zmm,
            vtype1::permutexvar(_mm512_set_epi64(NETWORK_64BIT_3), key_zmm),
            index_zmm,
            vtype2::permutexvar(_mm512_set_epi64(NETWORK_64BIT_3), index_zmm),
            0xCC);
    key_zmm = cmp_merge<vtype1, vtype2>(
            key_zmm,
            vtype1::template shuffle<SHUFFLE_MASK(1, 1, 1, 1)>(key_zmm),
                                                   ...
                                                   index_type &index_zmm)
{
    ...
    key_zmm = cmp_merge<vtype1, vtype2>(
            key_zmm,
            vtype1::permutexvar(_mm512_set_epi64(NETWORK_64BIT_4), key_zmm),
            index_zmm,
            vtype2::permutexvar(_mm512_set_epi64(NETWORK_64BIT_4), index_zmm),
            0xF0);
    // 2) half_cleaner[4]
    key_zmm = cmp_merge<vtype1, vtype2>(
            key_zmm,
                                                      ...
                                                      index_type &index_zmm2)
{
    ...
    key_zmm2 = vtype1::permutexvar(rev_index, key_zmm2);
    index_zmm2 = vtype2::permutexvar(rev_index, index_zmm2);
...
{
    const __m512i rev_index = _mm512_set_epi64(NETWORK_64BIT_2);
    zmm_t key_zmm4r = vtype1::permutexvar(rev_index, key_zmm[4]);
    ...
    zmm_t key_zmm_t5 = vtype1::permutexvar(rev_index, key_zmm_m4);
...
{
    const __m512i rev_index = _mm512_set_epi64(NETWORK_64BIT_2);
    zmm_t key_zmm8r = vtype1::permutexvar(rev_index, key_zmm[8]);
    zmm_t key_zmm9r = vtype1::permutexvar(rev_index, key_zmm[9]);
    zmm_t key_zmm10r = vtype1::permutexvar(rev_index, key_zmm[10]);
    zmm_t key_zmm11r = vtype1::permutexvar(rev_index, key_zmm[11]);
    zmm_t key_zmm12r = vtype1::permutexvar(rev_index, key_zmm[12]);
    zmm_t key_zmm13r = vtype1::permutexvar(rev_index, key_zmm[13]);
    ...
    zmm_t key_zmm_t9 = vtype1::permutexvar(rev_index, key_zmm_m8);
    zmm_t key_zmm_t10 = vtype1::permutexvar(rev_index, key_zmm_m7);
    zmm_t key_zmm_t11 = vtype1::permutexvar(rev_index, key_zmm_m6);
    zmm_t key_zmm_t12 = vtype1::permutexvar(rev_index, key_zmm_m5);
    zmm_t key_zmm_t13 = vtype1::permutexvar(rev_index, key_zmm_m4);
