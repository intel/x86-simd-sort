...
template <typename vtype,
          ...
          typename reg_t,
          typename argreg_t>
X86_SIMD_SORT_FINLINE int32_t partition_vec_avx512(type_t *arg,
                                                  arrsize_t left,
                                                  arrsize_t right,
...
template <typename vtype,
          ...
          typename reg_t,
          typename argreg_t>
X86_SIMD_SORT_FINLINE int32_t partition_vec_avx2(type_t *arg,
                                                arrsize_t left,
                                                arrsize_t right,
                                                const argreg_t arg_vec,
                                                const reg_t curr_vec,
...
template <typename vtype,
          ...
          typename reg_t,
          typename argreg_t>
X86_SIMD_SORT_FINLINE int32_t partition_vec(type_t *arg,
                                           arrsize_t left,
                                           arrsize_t right,
                                           const argreg_t arg_vec,
                                           const reg_t curr_vec,
