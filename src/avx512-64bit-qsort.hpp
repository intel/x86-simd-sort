...
template <typename vtype,
          ...
          typename index_t = zmm_vector<uint64_t>::zmm_t>
X86_SIMD_SORT_FORCEINLINE zmm_t sort_zmm_64bit(zmm_t key_zmm,
                                               index_t &index_zmm)
{
    const __m512i rev_index = _mm512_set_epi64(NETWORK_64BIT_2);
...
template <typename vtype,
          typename zmm_t = typename vtype::zmm_t,
          typename index_t = zmm_vector<uint64_t>::zmm_t>
X86_SIMD_SORT_FORCEINLINE zmm_t
                                                           ...
                                                           index_t &index_zmm2)
{
    ...
    index_t index_zmm3 = zmm_vector<uint64_t>::mask_mov(
            index_zmm2, vtype::eq(key_zmm3, key_zmm1), index_zmm1);
    index_t index_zmm4 = zmm_vector<uint64_t>::mask_mov(
...
template <typename vtype,
          typename zmm_t = typename vtype::zmm_t,
          typename index_t = zmm_vector<uint64_t>::zmm_t>
X86_SIMD_SORT_FORCEINLINE void bitonic_merge_four_zmm_64bit(zmm_t *key_zmm,
                                                            index_t *index_zmm)
{
    const __m512i rev_index = _mm512_set_epi64(NETWORK_64BIT_2);
    // 1) First step of a merging network
    ...
    index_t index_zmm_t1 = zmm_vector<uint64_t>::mask_mov(
            index_zmm3r, vtype::eq(key_zmm_t1, key_zmm[0]), index_zmm[0]);
    index_t index_zmm_m1 = zmm_vector<uint64_t>::mask_mov(
            index_zmm[0], vtype::eq(key_zmm_t1, key_zmm[0]), index_zmm3r);
    index_t index_zmm_t2 = zmm_vector<uint64_t>::mask_mov(
            index_zmm2r, vtype::eq(key_zmm_t2, key_zmm[1]), index_zmm[1]);
    index_t index_zmm_m2 = zmm_vector<uint64_t>::mask_mov(
    ...
    index_t index_zmm0 = zmm_vector<uint64_t>::mask_mov(
            index_zmm_t2, vtype::eq(key_zmm0, key_zmm_t1), index_zmm_t1);
    index_t index_zmm1 = zmm_vector<uint64_t>::mask_mov(
            index_zmm_t1, vtype::eq(key_zmm0, key_zmm_t1), index_zmm_t2);
    index_t index_zmm2 = zmm_vector<uint64_t>::mask_mov(
...
template <typename vtype,
          typename zmm_t = typename vtype::zmm_t,
          typename index_t = zmm_vector<uint64_t>::zmm_t>
X86_SIMD_SORT_FORCEINLINE void bitonic_merge_eight_zmm_64bit(zmm_t *key_zmm,
                                                             index_t *index_zmm)
{
    const __m512i rev_index = _mm512_set_epi64(NETWORK_64BIT_2);
    ...
    index_t index_zmm_t3 = zmm_vector<uint64_t>::mask_mov(
            index_zmm5r, vtype::eq(key_zmm_t3, key_zmm[2]), index_zmm[2]);
    index_t index_zmm_m3 = zmm_vector<uint64_t>::mask_mov(
            index_zmm[2], vtype::eq(key_zmm_t3, key_zmm[2]), index_zmm5r);
    index_t index_zmm_t4 = zmm_vector<uint64_t>::mask_mov(
            index_zmm4r, vtype::eq(key_zmm_t4, key_zmm[3]), index_zmm[3]);
    index_t index_zmm_m4 = zmm_vector<uint64_t>::mask_mov(
...
bitonic_merge_sixteen_zmm_64bit(zmm_t *key_zmm, index_t *index_zmm)
{
    const __m512i rev_index = _mm512_set_epi64(NETWORK_64BIT_2);
    ...
    index_t index_zmm_t5 = zmm_vector<uint64_t>::mask_mov(
            index_zmm11r, vtype::eq(key_zmm_t5, key_zmm[4]), index_zmm[4]);
    index_t index_zmm_m5 = zmm_vector<uint64_t>::mask_mov(
            index_zmm[4], vtype::eq(key_zmm_t5, key_zmm[4]), index_zmm11r);
    index_t index_zmm_t6 = zmm_vector<uint64_t>::mask_mov(
            index_zmm10r, vtype::eq(key_zmm_t6, key_zmm[5]), index_zmm[5]);
    index_t index_zmm_m6 = zmm_vector<uint64_t>::mask_mov(
            index_zmm[5], vtype::eq(key_zmm_t6, key_zmm[5]), index_zmm10r);
    index_t index_zmm_t7 = zmm_vector<uint64_t>::mask_mov(
            index_zmm9r, vtype::eq(key_zmm_t7, key_zmm[6]), index_zmm[6]);
    index_t index_zmm_m7 = zmm_vector<uint64_t>::mask_mov(
            index_zmm[6], vtype::eq(key_zmm_t7, key_zmm[6]), index_zmm9r);
    index_t index_zmm_t8 = zmm_vector<uint64_t>::mask_mov(
            index_zmm8r, vtype::eq(key_zmm_t8, key_zmm[7]), index_zmm[7]);
    index_t index_zmm_m8 = zmm_vector<uint64_t>::mask_mov(
...
sort_8_64bit(type_t *keys, uint64_t *indexes, int32_t N)
{
    ...
    if (indexes) {
        zmm_vector<uint64_t>::zmm_t index_zmm
                = zmm_vector<uint64_t>::mask_loadu(
...
sort_16_64bit(type_t *keys, uint64_t *indexes, int32_t N)
{
    ...
    if (indexes) {
        ...
        index_t index_zmm2 = zmm_vector<uint64_t>::mask_loadu(
...
sort_32_64bit(type_t *keys, uint64_t *indexes, int32_t N)
{
    ...
    if (indexes) {
        ...
        zmm_vector<uint64_t>::mask_storeu(
...
template <typename vtype, typename type_t>
X86_SIMD_SORT_FORCEINLINE type_t get_pivot_64bit(type_t *keys,
                                                 uint64_t *indexes,
                                                 const int64_t left,
                                                 const int64_t right)
{
                         ...
                         int64_t max_iters)
{
    ...
    if (right + 1 - left <= 128) {
        if (indexes)
            ...
            sort_128_64bit<vtype>(
                    keys + left, (uint64_t *)NULL, (int32_t)(right + 1 - left));
        return;
    }
...
template <>
inline void
avx512_qsort<int64_t>(int64_t *keys, uint64_t *indexes, int64_t arrsize)
{
    if (arrsize > 1) {
        qsort_64bit_<zmm_vector<int64_t>, int64_t>(
                ...
                0,
                arrsize - 1,
                2 * (63 - __builtin_clzll(arrsize)));
    }
}

template <>
inline void
avx512_qsort<uint64_t>(uint64_t *keys, uint64_t *indexes, int64_t arrsize)
{
    if (arrsize > 1) {
...
template <>
inline void
avx512_qsort<double>(double *keys, uint64_t *indexes, int64_t arrsize)
{
    if (arrsize > 1) {
